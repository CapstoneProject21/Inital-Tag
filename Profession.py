...
#removing tag parent
def remove_tag_parent(tag_id):
    payload = "{\"query\":\"mutation removeTagParent ($tagid: ID!, $parentsID: ID!) {\\n    removeTagParent (tagid: $tagid, parentsID: $parentsID) {\\n        TagID\\n        Name\\n        Alias\\n        Children\\n        Parent\\n        Weight\\n        Opposite\\n        Image\\n    }\\n}\",\"variables\":{\"tagid\":\""+tag_id+"\",\"parentsID\":0}}"
    headers = {
    'Content-Type': 'application/json'
    }
    conn.request("POST", "/query", payload, headers)
...
#removing tag child
def remove_tag_child(tag_id):
    payload = "{\"query\":\"mutation removeTagChild ($tagid: ID!, $childsID: ID!) {\\n    removeTagChild (tagid: $tagid, childsID: $childsID) {\\n        TagID\\n        Name\\n        Alias\\n        Children\\n        Parent\\n        Weight\\n        Opposite\\n        Image\\n    }\\n}\",\"variables\":{\"tagid\":\""+tag_id+"\",\"childsID\":0}}"
    headers = {
    'Content-Type': 'application/json'
    }
    conn.request("POST", "/query", payload, headers)
...
def main():
    ...
    for tag_name in total_list:
        ...
        remove_tag_child(tag_id)
        remove_tag_parent(tag_id)        
